...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <nav class="navbar navbar-expand-lg navbar-light" style="background:white; text-align:center;">
                    ...
                    <div class="row text-white" style="background: rgb(242,239,239); margin: 0.5rem;">
                        ...
                        <div class="col-md-12 mx-auto">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:Label ID="lblMsgAviso" runat="server" Text=""></asp:Label><br />
                                    <div class="row">
                ...
                <div class="row" runat="server" id="CambioPsw" visible="false">
                    ...
                    <div class="row text-white" style="background: rgb(242,239,239); margin: 0.5rem;">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:Button ID="btnCPSW" runat="server" Text="Generar Nueva Contraseña" Style="margin-top: 0.5rem;" Font-Size="Small" CssClass="btnEntrar btn btn-dark form-control form-control-sm" /><%-- OnClick="btnCPSW_Click" />--%>
                ...
                <div class="row text-white" id="listUsers" >
                        ...
                        <ContentTemplate>
                          <asp:GridView ID="GVSolicitudes" runat="server" Visible="true" EmptyDataText="No hay nuevas solicitudes de registro."  BorderColor="#CCCCCC" BorderStyle="None" CaptionAlign="Top" CssClass="table table-responsive shadow" AutoGenerateColumns="False" AllowPaging="True" Font-Size="X-Small" PagerStyle-BackColor="White" Width="100%" OnSelectedIndexChanged="GVSolicitudes_SelectedIndexChanged" OnRowCommand="GVSolicitudes_RowCommand" OnPageIndexChanging="GVSolicitudes_PageIndexChanging">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="nombreDoc" HeaderText="Archivo" >
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:BoundField>
                                        </Columns>                           
                            ...
                            <Triggers>
                                    <asp:PostBackTrigger ControlID="GVSolicitudes"></asp:PostBackTrigger>
                            </Triggers>
                         </asp:UpdatePanel>

                           <asp:GridView ID="GVRegistrados" runat="server" Visible="false" EmptyDataText="No hay registros." DataKeyNames="cedulaP" BorderColor="#CCCCCC" BorderStyle="None" CaptionAlign="Top" CssClass="table table-responsive shadow" AutoGenerateColumns="False" AllowPaging="True" Font-Size="X-Small" PagerStyle-BackColor="White" Width="100%"  OnRowCancelingEdit="GVRegistrados_RowCancelingEdit" OnRowUpdating="GVRegistrados_RowUpdating" OnRowEditing="GVRegistrados_RowEditing">
                                    <AlternatingRowStyle BackColor="#F2E7EB" />
                                    <Columns>
                    ...
                    <asp:GridView ID="GVCambioPss" runat="server" Visible="False" EmptyDataText="No hay registros."  BorderColor="#CCCCCC" BorderStyle="None" CaptionAlign="Top" CssClass="table table-responsive shadow" AutoGenerateColumns="False" AllowPaging="True" Font-Size="X-Small" PagerStyle-BackColor="White" Width="100%" OnRowCommand="GVCambioPss_RowCommand"> 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="cambioPsw" HeaderText="Cambio Comtraseña">
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                        <asp:ImageField>
                                        </asp:ImageField>
    ...
    <script type="text/javascript">        
        ...
        function OpenModalAprob(nombrec, usuario, psw) {
            ...
            $('#<%=lblPersona.ClientID%>').html(nombrec);///sirve para enviar parametros
